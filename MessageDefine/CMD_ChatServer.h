...
//{
//	DWORD								dwSenderID;
////用户标识 	TCHAR								szNickName[LEN_ACCOUNTS];
////用户昵称 	DWORD								dwFontColor;
////字体颜色 	BYTE								cbFontSize;
////字体大小 	BYTE								cbFontAttri;
////字体属性 	TCHAR								szFontName[LEN_FONT_NAME];
////字体名称 	TCHAR								szMessageContent[LEN_MESSAGE_CONTENT];
////消息内容
// };
