...
private:
  ...
  // 字符串拆分
  VOID SplitString(const StringT& strSource, const StringT& strSpliter, std::vector<StringT>& ResultArray);
  // 是否为纯数字
...
typedef std::unordered_map<DWORD, CServerUserItem*> CServerUserItemMap;
