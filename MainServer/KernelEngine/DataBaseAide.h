...
//////////////////////////////////////////////////////////////////////////////////
#define adParamOutput nanodbc::statement::PARAM_OUT
#define adParamInput nanodbc::statement::PARAM_IN
...
public:
  ...
  // 插入参数
  VOID AddParameter(LPCTSTR pszItem, StringViewT pszString, nanodbc::statement::param_direction ParameterDirection = nanodbc::statement::PARAM_IN);
  // 插入参数
  VOID AddParameter(LPCTSTR pszItem, std::u16string_view pszString, nanodbc::statement::param_direction ParameterDirection = nanodbc::statement::PARAM_IN);
  // 插入参数
  VOID AddParameter(LPCTSTR pszItem, const SYSTEMTIME& SystemTime,
                    nanodbc::statement::param_direction ParameterDirection = nanodbc::statement::PARAM_IN);
  // 插入参数
  VOID AddParameterOutput(LPCTSTR pszItem, TCHAR* pszString, UINT uSize,
