...
// 数组说明
using CGameTypeItemArray = std::vector<CGameTypeItem*>;
using CGameKindItemArray = std::vector<CGameKindItem*>;
using CGameNodeItemArray = std::vector<CGameNodeItem*>;
using CGamePageItemArray = std::vector<CGamePageItem*>;
using CGameServerItemArray = std::vector<CGameServerItem*>;

// 索引说明
using CTypeItemMap = std::unordered_map<WORD, CGameTypeItem*>;
using CKindItemMap = std::unordered_map<WORD, CGameKindItem*>;
using CNodeItemMap = std::unordered_map<WORD, CGameNodeItem*>;
using CPageItemMap = std::unordered_map<WORD, CGamePageItem*>;
using CServerItemMap = std::unordered_map<WORD, CGameServerItem*>;
