...
// 数组说明
using CGamePropertyTypeItemArray = std::vector<CGamePropertyTypeItem*>;
using CGamePropertyRelatItemArray = std::vector<CGamePropertyRelatItem*>;
using CGamePropertyItemArray = std::vector<CGamePropertyItem*>;
using CGamePropertySubItemArray = std::vector<CGamePropertySubItem*>;

// 索引说明
using CGamePropertyTypeItemMap = std::unordered_map<DWORD, CGamePropertyTypeItem*>;
using CGamePropertyRelatItemMap = std::unordered_map<DWORD, CGamePropertyRelatItem*>;
using CGamePropertyItemMap = std::unordered_map<DWORD, CGamePropertyItem*>;
using CGamePropertySubItemMap = std::unordered_map<DWORD, CGamePropertySubItem*>;
