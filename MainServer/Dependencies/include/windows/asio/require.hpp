...
namespace asio_require_fn {
  ...
  enum overload_type { identity, call_member, call_free, two_props, n_props, ill_formed };
...
namespace asio {
  ...
  template<typename T, typename... Properties>
  struct can_require
      : integral_constant<bool, asio_require_fn::call_traits<require_t, T, void(Properties...)>::overload != asio_require_fn::ill_formed> {};
  ...
  template<typename T, typename... Properties>
  struct is_nothrow_require : integral_constant<bool, asio_require_fn::call_traits<require_t, T, void(Properties...)>::is_noexcept> {};
