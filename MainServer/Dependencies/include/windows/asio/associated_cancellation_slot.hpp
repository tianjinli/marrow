...
namespace asio {
  ...
  namespace detail {
    ...
    struct associated_cancellation_slot_impl<T, S, void_t<typename T::cancellation_slot_type>> {
      ...
      static auto get(const T& t, const S&) noexcept -> decltype(t.get_cancellation_slot()) { return t.get_cancellation_slot(); }
    };
   ...
   */
  template<typename T>
  ASIO_NODISCARD inline typename associated_cancellation_slot<T>::type get_associated_cancellation_slot(const T& t) noexcept {
  ...
  namespace detail {
    ...
    template<typename T, typename S>
    struct associated_cancellation_slot_forwarding_base<
        T, S, enable_if_t<is_same<typename associated_cancellation_slot<T, S>::asio_associated_cancellation_slot_is_unspecialised, void>::value>> {
      typedef void asio_associated_cancellation_slot_is_unspecialised;
    };
...
#endif // !defined(GENERATING_DOCUMENTATION)
  {
    ...
    static type get(reference_wrapper<T> t) noexcept { return associated_cancellation_slot<T, CancellationSlot>::get(t.get()); }
