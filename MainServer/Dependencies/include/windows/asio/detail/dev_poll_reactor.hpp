...
namespace asio {
  namespace detail {
    ...
    public:
      ...
      ASIO_DECL void start_op(int op_type, socket_type descriptor, per_descriptor_data&, reactor_op* op, bool is_continuation, bool allow_speculative,
      ...
      void start_op(int op_type, socket_type descriptor, per_descriptor_data& descriptor_data, reactor_op* op, bool is_continuation,
        ...
        start_op(op_type, descriptor, descriptor_data, op, is_continuation, allow_speculative, &dev_poll_reactor::call_post_immediate_completion,
                 this);
      }
