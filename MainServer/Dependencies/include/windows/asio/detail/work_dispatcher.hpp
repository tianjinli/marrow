...
namespace asio {
  namespace detail {
    ...
    struct is_work_dispatcher_required<
        Handler, Executor,
        enable_if_t<is_same<typename associated_executor<Handler, Executor>::asio_associated_executor_is_unspecialised, void>::value>> : false_type {
    };
    ...
    public:
      ...
      void operator()() {
        ...
        asio::prefer(executor_, execution::allocator(alloc)).execute(asio::detail::bind_handler(static_cast<Handler&&>(handler_)));
      }
