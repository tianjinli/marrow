  ...
  namespace detail {
    ...
    public:
      ...
      virtual long wait_duration_msec(long max_duration) const {
        ...
        return this->to_msec(Time_Traits::to_posix_duration(Time_Traits::subtract(heap_[0].time_, Time_Traits::now())), max_duration);
      }
      ...
      virtual long wait_duration_usec(long max_duration) const {
        ...
        return this->to_usec(Time_Traits::to_posix_duration(Time_Traits::subtract(heap_[0].time_, Time_Traits::now())), max_duration);
      }
      ...
      void down_heap(std::size_t index) {
        ...
        while (child < heap_.size()) {
          std::size_t min_child =
              (child + 1 == heap_.size() || Time_Traits::less_than(heap_[child].time_, heap_[child + 1].time_)) ? child : child + 1;
