...
namespace asio {
  namespace detail {
    ...
    public:
      ...
      native_handle_type native_handle(const implementation_type& impl) const { return handle_service_.native_handle(impl); }

      // Release ownership of a file.
      native_handle_type release(implementation_type& impl, asio::error_code& ec) { return handle_service_.release(impl, ec); }

      // Cancel all operations associated with the file.
      asio::error_code cancel(implementation_type& impl, asio::error_code& ec) { return handle_service_.cancel(impl, ec); }
