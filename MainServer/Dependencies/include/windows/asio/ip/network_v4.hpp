...
namespace asio {
  namespace ip {
    ...
    public:
      ...
      address_v4 broadcast() const noexcept { return address_v4(network().to_uint() | (netmask().to_uint() ^ 0xFFFFFFFF)); }
      ...
      friend bool operator==(const network_v4& a, const network_v4& b) { return a.address_ == b.address_ && a.prefix_length_ == b.prefix_length_; }
