...
namespace asio {
  namespace error {
    ...
    enum addrinfo_errors {
      ...
      socket_type_not_supported = ASIO_WIN_OR_POSIX(ASIO_NATIVE_ERROR(WSAESOCKTNOSUPPORT), ASIO_GETADDRINFO_ERROR(EAI_SOCKTYPE))
    };
...
#if !defined(ASIO_ERROR_LOCATION) && !defined(ASIO_DISABLE_ERROR_LOCATION) && defined(ASIO_HAS_BOOST_CONFIG) && (BOOST_VERSION >= 107900)
