...
namespace asio {
  ...
  public:
    /// Copy constructor.
    basic_executor_type(const basic_executor_type& other) noexcept : pool_(other.pool_), allocator_(other.allocator_), bits_(other.bits_) {
  ...
  private:
     ...
     */
    constexpr basic_executor_type<Allocator, ASIO_UNSPECIFIED(Bits & ~blocking_mask)> require(execution::blocking_t::possibly_t) const {
    ...
    constexpr basic_executor_type<Allocator, ASIO_UNSPECIFIED((Bits & ~blocking_mask) | blocking_always)> require(
      ...
      return basic_executor_type<Allocator, ASIO_UNSPECIFIED((Bits & ~blocking_mask) | blocking_always)>(pool_, allocator_, bits_ & ~blocking_mask);
    }
     ...
     */
    constexpr basic_executor_type<Allocator, ASIO_UNSPECIFIED(Bits & ~blocking_mask)> require(execution::blocking_t::never_t) const {
      return basic_executor_type < Allocator, Bits & ~blocking_mask > (pool_, allocator_, (bits_ & ~blocking_mask) | blocking_never);
    }
  ...
  private:
    ...
    constexpr execution::blocking_t query(execution::blocking_t) const noexcept {
      return (bits_ & blocking_never) ? execution::blocking_t(execution::blocking.never)
  ...
  private:
    ...
    basic_executor_type(thread_pool* p, const Allocator& a, unsigned int bits) noexcept : pool_(p), allocator_(a), bits_(bits) {
      if (Bits & outstanding_work_tracked) {
        if (pool_) {
          pool_->scheduler_.work_started();
        }
  ...
  namespace traits {
    ...
    template<typename Allocator, unsigned int Bits>
    struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::relationship_t::continuation_t> {
      static constexpr bool is_valid = true;
      static constexpr bool is_noexcept = false;
      typedef asio::thread_pool::basic_executor_type<Allocator, Bits> result_type;
    };
    ...
    template<typename Allocator, unsigned int Bits>
    struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::outstanding_work_t::tracked_t>
        : asio::detail::thread_pool_bits {
      static constexpr bool is_valid = true;
      static constexpr bool is_noexcept = false;
    ...
    template<typename Allocator, unsigned int Bits>
    struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::outstanding_work_t::untracked_t>
        : asio::detail::thread_pool_bits {
      static constexpr bool is_valid = true;
      static constexpr bool is_noexcept = false;
      typedef asio::thread_pool::basic_executor_type<Allocator, Bits & ~outstanding_work_tracked> result_type;
    ...
    struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::allocator_t<OtherAllocator> > {
      static constexpr bool is_valid = true;
      static constexpr bool is_noexcept = false;
    ...
    struct query_static_constexpr_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, Property,
    ...
    struct query_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::allocator_t<OtherAllocator> > {
      static constexpr bool is_valid = true;
      static constexpr bool is_noexcept = true;
      typedef Allocator result_type;
    };
