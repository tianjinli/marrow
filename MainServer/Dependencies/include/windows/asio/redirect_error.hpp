...
namespace asio {
  ...
  public:
    ...
    template<typename CompletionToken>
    ASIO_NODISCARD inline constexpr redirect_error_t<decay_t<CompletionToken>> operator()(CompletionToken&& completion_token) const {
  ...
  template<typename CompletionToken>
  ASIO_NODISCARD inline redirect_error_t<decay_t<CompletionToken>> redirect_error(CompletionToken&& completion_token, asio::error_code& ec) {
