...
namespace asio {
  namespace detail {
    ...
    public:
      ...
      execution_context& query(execution::context_t) const noexcept { return asio::query(system_executor(), execution::context); }
    ...
    public:
      ...
      promise_handler(use_future_t<Allocator> u) : allocator_(u.get_allocator()) { this->create_promise(allocator_); }
    ...
    public:
      ...
      packaged_handler(packaged_token<Function, Allocator> t) : function_(static_cast<Function&&>(t.function_)), allocator_(t.allocator_) {
  ...
  class async_result<use_future_t<Allocator>, Result(Args...)> : public detail::promise_async_result<void(decay_t<Args>...), Allocator> {
  public:
    explicit async_result(typename detail::promise_async_result<void(decay_t<Args>...), Allocator>::completion_handler_type& h) :
  ...
  public:
    explicit async_result(typename detail::packaged_async_result<Function, Allocator, result_of_t<Function(Args...)>>::completion_handler_type& h) :
  ...
  namespace traits {
    ...
    struct query_static_constexpr_member<asio::detail::promise_executor<T, Blocking>, Property,
