...
#if defined(ASIO_HAS_WINDOWS_RANDOM_ACCESS_HANDLE) || defined(ASIO_HAS_WINDOWS_STREAM_HANDLE) || defined(GENERATING_DOCUMENTATION)
...
namespace asio {
  namespace windows {
    ...
    public:
       ...
       */
      template<typename Executor1>
      constraint_t<is_convertible<Executor1, Executor>::value, basic_overlapped_handle&> operator=(basic_overlapped_handle<Executor1>&& other) {
        impl_ = std::move(other.impl_);
        return *this;
      }
