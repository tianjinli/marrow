...
namespace asio {
  namespace local {
    ...
    /// Create a pair of connected sockets.
    template<typename Protocol, typename Executor1, typename Executor2>
    ASIO_SYNC_OP_VOID connect_pair(basic_socket<Protocol, Executor1>& socket1, basic_socket<Protocol, Executor2>& socket2, asio::error_code& ec);
    ...
    template<typename Protocol, typename Executor1, typename Executor2>
    inline ASIO_SYNC_OP_VOID connect_pair(basic_socket<Protocol, Executor1>& socket1, basic_socket<Protocol, Executor2>& socket2,
                                          asio::error_code& ec) {
