...
namespace asio_require_concept_fn {
  ...
  struct call_traits<Impl, T, void(Property), enable_if_t<is_applicable_property<decay_t<T>, decay_t<Property> >::value>,
                     enable_if_t<decay_t<Property>::is_requirable_concept>, enable_if_t<static_require_concept<T, Property>::is_valid> > {
  ...
  struct impl {
    ...
    struct proxy {
      ...
      struct type {
        template<typename P>
        auto require_concept(P&& p) noexcept(noexcept(declval<conditional_t<true, T, P> >().require_concept(static_cast<P&&>(p))))
...
namespace asio {
  namespace {
    ...
    static constexpr const asio_require_concept_fn::impl& require_concept = asio_require_concept_fn::static_instance<>::instance;
  ...
  template<typename T, typename Property>
  struct can_require_concept : integral_constant<bool, asio_require_concept_fn::call_traits<require_concept_t, T, void(Property)>::overload !=
