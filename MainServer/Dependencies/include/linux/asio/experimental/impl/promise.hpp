...
namespace asio {
  namespace experimental {
    ...
    template<typename Signature = void(), typename Executor = asio::any_io_executor, typename Allocator = std::allocator<void>>
    struct promise;
    ...
    namespace detail {
      ...
      struct promise_impl<void(Ts...), Executor, Allocator> {
        ...
        promise_impl(Allocator allocator, Executor executor) : allocator(std::move(allocator)), executor(std::move(executor)) {}
        ...
        struct completion_impl final : completion_base {
          ...
          void invoke(Ts&&... ts) {
            ...
            using alloc_t = typename std::allocator_traits<typename asio::decay<Alloc>::type>::template rebind_alloc<completion_impl>;
          ...
          completion_impl(Alloc_&& alloc, Handler_&& wh) : handler(std::forward<Handler_>(wh)), allocator(std::forward<Alloc_>(alloc)) {}
        };
        ...
        void set_completion(Alloc&& alloc, Handler&& handler) {
          ...
          using alloc_t = typename std::allocator_traits<typename asio::decay<Alloc>::type>::template rebind_alloc<impl_t>;
