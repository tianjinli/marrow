  ...
  namespace experimental {
    namespace detail {
      ...
      public:
        ...
        template<typename Traits, typename... Signatures>
        void move_construct(implementation_type<Traits, Signatures...>& impl, implementation_type<Traits, Signatures...>& other_impl);
        ...
        template<typename Message, typename Traits, typename... Signatures, typename... Args>
        std::size_t try_send_n(implementation_type<Traits, Signatures...>& impl, std::size_t count, bool via_dispatch, Args&&... args);
        ...
        void async_send(implementation_type<Traits, Signatures...>& impl, typename implementation_type<Traits, Signatures...>::payload_type&& payload,
                        Handler& handler, const IoExecutor& io_ex) {
          associated_cancellation_slot_t<Handler> slot = asio::get_associated_cancellation_slot(handler);

          // Allocate and construct an operation to wrap the handler.
          typedef channel_send_op<typename implementation_type<Traits, Signatures...>::payload_type, Handler, IoExecutor> op;
          typename op::ptr p = {asio::detail::addressof(handler), op::ptr::allocate(handler), 0};
          p.p = new (p.v) op(static_cast<typename implementation_type<Traits, Signatures...>::payload_type&&>(payload), handler, io_ex);
        ...
        void async_receive(implementation_type<Traits, Signatures...>& impl, Handler& handler, const IoExecutor& io_ex) {
          ...
          // Allocate and construct an operation to wrap the handler.
          typedef channel_receive_op<typename implementation_type<Traits, Signatures...>::payload_type, Handler, IoExecutor> op;
          typename op::ptr p = {asio::detail::addressof(handler), op::ptr::allocate(handler), 0};
      ...
      struct channel_service<Mutex>::implementation_type : base_implementation_type {
        ...
        typedef conditional_t<has_signature<typename traits_type::receive_cancelled_signature, Signatures...>::value,
                              ...
                              conditional_t<has_signature<typename traits_type::receive_closed_signature, Signatures...,
      ...
      struct channel_service<Mutex>::implementation_type<Traits, R()> : channel_service::base_implementation_type {
        ...
        typedef conditional_t<
            ...
            conditional_t<has_signature<typename traits_type::receive_closed_signature, R()>::value, asio::detail::completion_payload<R()>,
                          asio::detail::completion_payload<R(), typename traits_type::receive_closed_signature>>,
            conditional_t<
                has_signature<typename traits_type::receive_closed_signature, R(), typename traits_type::receive_cancelled_signature>::value,
        ...
        // Get the element at the front of the buffer.
        payload_type buffer_front() { return payload_type(asio::detail::completion_message<R()>(0)); }
      ...
      template<typename Mutex>
      template<typename Traits, typename R>
      struct channel_service<Mutex>::implementation_type<Traits, R(asio::error_code)> : channel_service::base_implementation_type {
        // The traits type associated with the channel.
        ...
        typedef conditional_t<has_signature<typename traits_type::receive_cancelled_signature, R(asio::error_code)>::value,
                              ...
                              conditional_t<has_signature<typename traits_type::receive_closed_signature, R(asio::error_code),
                                                          typename traits_type::receive_cancelled_signature>::value,
