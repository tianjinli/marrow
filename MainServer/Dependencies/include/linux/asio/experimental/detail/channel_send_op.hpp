...
namespace asio {
  namespace experimental {
    namespace detail {
      ...
      protected:
        channel_send(func_type func, Payload&& payload) : channel_operation(func), payload_(static_cast<Payload&&>(payload)) {}
      ...
      public:
        ...
        static void do_action(channel_operation* base, channel_operation::action a, void*) {
          ...
          channel_operation::handler_work<Handler, IoExecutor> w(static_cast<channel_operation::handler_work<Handler, IoExecutor>&&>(o->work_));
