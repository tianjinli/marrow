...
namespace asio {
  ...
  namespace execution {
    ...
    struct allocator_t {
      ...
      template<typename T>
      struct query_static_constexpr_member : traits::query_static_constexpr_member<typename static_proxy<T>::type, allocator_t> {};

#if defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT) && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)
      template<typename T>
      static constexpr typename query_static_constexpr_member<T>::result_type static_query() noexcept(query_static_constexpr_member<T>::is_noexcept) {
  ...
  struct is_applicable_property<T, execution::allocator_t<ProtoAllocator> > : integral_constant<bool, execution::is_executor<T>::value> {};
  ...
  namespace traits {
    ...
    struct static_query<T, execution::allocator_t<ProtoAllocator>,
      ...
      typedef typename execution::allocator_t<ProtoAllocator>::template query_static_constexpr_member<T>::result_type result_type;

      static constexpr result_type value() { return execution::allocator_t<ProtoAllocator>::template query_static_constexpr_member<T>::value(); }
    };
