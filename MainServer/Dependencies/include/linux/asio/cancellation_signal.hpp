...
namespace asio {
  ...
  public:
    ...
    CancellationHandler& emplace(Args&&... args) {
      ...
      cancellation_handler_type* handler_obj = new (del.mem.first) cancellation_handler_type(del.mem.second, static_cast<Args&&>(args)...);
      del.mem.first = 0;
    ...
    friend constexpr bool operator==(const cancellation_slot& lhs, const cancellation_slot& rhs) noexcept { return lhs.handler_ == rhs.handler_; }
