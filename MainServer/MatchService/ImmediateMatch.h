...
// 数组定义
using CMatchLoopTimerArray = std::vector<BYTE>;
using CMatchGroupArray = std::vector<CImmediateGroup*>;
using CMatchRewardArray = std::vector<tagMatchReward*>;
using CTimerItemPtr = std::vector<tagMatchTimerItem*>;
using CMatchTableArray = std::vector<CTableFrameHook*>;
using CMatchUserItemArray = std::vector<IServerUserItem*>;
