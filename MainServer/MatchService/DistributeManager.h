...
// 类型定义
using CSameTableArray = std::vector<tagSameTableInfo*>; // 同坐数组
using CDistributeInfoArray = std::vector<tagDistributeInfo>; // 分组数组
using CSameTableMap = std::unordered_map<DWORD, tagSameTableInfo*>; // 同桌信息
