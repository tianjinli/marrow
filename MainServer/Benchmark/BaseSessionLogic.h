...
public:
   ...
   * @return 发送结果
   */
  virtual asio::awaitable<bool> Sending(const uint16_t main, const uint16_t sub) { return Sending(main, sub, nullptr, 0); }
   ...
   * @return 当前会话上下文
   */
  [[nodiscard]] std::shared_ptr<SessionContext> Context() override { return ctx_; }
};
