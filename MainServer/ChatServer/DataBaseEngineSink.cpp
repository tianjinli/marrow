...
bool CDataBaseEngineSink::OnRequestLogonUserID(DWORD dwContextID, VOID* pData, WORD wDataSize) {
  ...
  try {
    ...
    if (pLogonUserID->wLogonComand & LOGON_COMMAND_USERINFO) {
      ...
      m_AccountsDBAide.AddParameterOutput(TEXT("@strErrorDescribe"), m_LogonFailure.szDescribeString, sizeof(m_LogonFailure.szDescribeString),
                                          adParamOutput);
    ...
    if (pLogonUserID->wLogonComand & LOGON_COMMAND_GROUPINFO) {
      ...
      if (lResultCode == DB_SUCCESS && m_AccountsDBModule.GetInterface()) {
        ...
        while (m_AccountsDBModule->IsRecordsetEnd() == false) {
          ...
          m_AccountsDBAide.GetValue_String(TEXT("GroupName"), UserGroupInfo.GroupInfo[UserGroupInfo.wGroupCount].szGroupName,
                                           CountArray(UserGroupInfo.GroupInfo[UserGroupInfo.wGroupCount].szGroupName));
    ...
    if (pLogonUserID->wLogonComand & LOGON_COMMAND_FRIENDS) {
      ...
      if (lResultCode == DB_SUCCESS && m_AccountsDBModule.GetInterface()) {
        ...
        while (m_AccountsDBModule->IsRecordsetEnd() == false) {
          ...
          m_AccountsDBAide.GetValue_String(TEXT("NickName"), UserFriendInfo.FriendInfo[UserFriendInfo.wFriendCount].szNickName,
                                           CountArray(UserFriendInfo.FriendInfo[UserFriendInfo.wFriendCount].szNickName));
          m_AccountsDBAide.GetValue_String(TEXT("UnderWrite"), UserFriendInfo.FriendInfo[UserFriendInfo.wFriendCount].szUnderWrite,
                                           CountArray(UserFriendInfo.FriendInfo[UserFriendInfo.wFriendCount].szUnderWrite));
          m_AccountsDBAide.GetValue_String(TEXT("Compellation"), UserFriendInfo.FriendInfo[UserFriendInfo.wFriendCount].szCompellation,
                                           CountArray(UserFriendInfo.FriendInfo[UserFriendInfo.wFriendCount].szCompellation));

          // 简易资料
          UserIndividual.UserIndividual[UserIndividual.wUserCount].dwUserID = m_AccountsDBAide.GetValue_DWORD(TEXT("UserID"));
          m_AccountsDBAide.GetValue_String(TEXT("QQ"), UserIndividual.UserIndividual[UserIndividual.wUserCount].szQQ,
                                           CountArray(UserIndividual.UserIndividual[UserIndividual.wUserCount].szQQ));
          m_AccountsDBAide.GetValue_String(TEXT("EMail"), UserIndividual.UserIndividual[UserIndividual.wUserCount].szEMail,
                                           CountArray(UserIndividual.UserIndividual[UserIndividual.wUserCount].szEMail));
          m_AccountsDBAide.GetValue_String(TEXT("SeatPhone"), UserIndividual.UserIndividual[UserIndividual.wUserCount].szSeatPhone,
                                           CountArray(UserIndividual.UserIndividual[UserIndividual.wUserCount].szSeatPhone));
          m_AccountsDBAide.GetValue_String(TEXT("MobilePhone"), UserIndividual.UserIndividual[UserIndividual.wUserCount].szMobilePhone,
                                           CountArray(UserIndividual.UserIndividual[UserIndividual.wUserCount].szMobilePhone));
          m_AccountsDBAide.GetValue_String(TEXT("DwellingPlace"), UserIndividual.UserIndividual[UserIndividual.wUserCount].szDwellingPlace,
                                           CountArray(UserIndividual.UserIndividual[UserIndividual.wUserCount].szDwellingPlace));
          m_AccountsDBAide.GetValue_String(TEXT("PostalCode"), UserIndividual.UserIndividual[UserIndividual.wUserCount].szPostalCode,
                                           CountArray(UserIndividual.UserIndividual[UserIndividual.wUserCount].szPostalCode));
    ...
    if (pLogonUserID->wLogonComand & LOGON_COMMAND_REMARKS) {
      ...
      if (lResultCode == DB_SUCCESS && m_AccountsDBModule.GetInterface()) {
        ...
        while (m_AccountsDBModule->IsRecordsetEnd() == false) {
          ...
          m_AccountsDBAide.GetValue_String(TEXT("UserNote"), UserRemarksInfo.RemarksInfo[UserRemarksInfo.wFriendCount].szRemarksInfo,
                                           CountArray(UserRemarksInfo.RemarksInfo[UserRemarksInfo.wFriendCount].szRemarksInfo));
  ...
  try {
    ...
    if (lResultCode == DB_SUCCESS) {
      ...
      if (AddFriend.bLoadUserInfo == true) {
        ...
        m_AccountsDBAide.GetValue_String(TEXT("NickName"), UserFriendInfo.FriendInfo[0].szNickName,
                                         CountArray(UserFriendInfo.FriendInfo[0].szNickName));
        m_AccountsDBAide.GetValue_String(TEXT("UnderWrite"), UserFriendInfo.FriendInfo[0].szUnderWrite,
                                         CountArray(UserFriendInfo.FriendInfo[0].szUnderWrite));
        m_AccountsDBAide.GetValue_String(TEXT("Compellation"), UserFriendInfo.FriendInfo[0].szCompellation,
...
bool CDataBaseEngineSink::OnRequestModifyGroup(DWORD dwContextID, VOID* pData, WORD wDataSize) {
  ...
  try {
    ...
    if (lResultCode == DB_SUCCESS) {
      ...
      StringT DBVarValue;
      m_AccountsDBModule->GetParameter(TEXT("@strErrorDescribe"), DBVarValue);
      lstrcpyn(ModifyGroup.szDescribeString, DBVarValue.c_str(), CountArray(ModifyGroup.szDescribeString));
    }
  ...
  try {
    ...
    if (lResultCode == DB_SUCCESS && m_AccountsDBModule.GetInterface()) {
      if (m_AccountsDBModule->IsRecordsetEnd() == false) {
        ...
        m_AccountsDBAide.GetValue_String(TEXT("NickName"), SearchUserResult.FriendInfo.szNickName,
                                         CountArray(SearchUserResult.FriendInfo.szNickName));
        m_AccountsDBAide.GetValue_String(TEXT("UnderWrite"), SearchUserResult.FriendInfo.szUnderWrite,
                                         CountArray(SearchUserResult.FriendInfo.szUnderWrite));
...
// 登录结果
VOID CDataBaseEngineSink::OnLogonDisposeResult(DWORD dwContextID, DWORD dwErrorCode, LPCTSTR pszErrorString, bool bMobileClient, WORD wBehaviorFlags,
...
// 操作结果
VOID CDataBaseEngineSink::OnUserOperateResult(DWORD dwContextID, bool bOperateSucess, DWORD dwErrorCode, WORD wOperateCode,
                                              LPCTSTR pszDescribeString) {
  // 变量定义
