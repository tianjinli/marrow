...
protected:
  ...
  // 组件变量
protected:
  CInitParameter* m_pInitParameter = nullptr; // 配置参数
...
private:
  // 登录结果
  VOID OnLogonDisposeResult(DWORD dwContextID, DWORD dwErrorCode, LPCTSTR pszErrorString, bool bMobileClient, WORD wBehaviorFlags = 0,
                            WORD wPageTableCount = 0);
  // 操作结果
