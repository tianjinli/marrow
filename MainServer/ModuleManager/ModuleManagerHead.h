...
#define MODULE_MANAGER_CLASS __declspec(dllexport)
#else
#define MODULE_MANAGER_CLASS __declspec(dllimport)
#endif
#define MODULE_MANAGER_DLL_NAME TEXT("ModuleManager.dll") // 组件 DLL 名字
#else
#define MODULE_MANAGER_CLASS
#define MODULE_MANAGER_DLL_NAME TEXT("ModuleManager.so") // 组件 DLL 名字
#endif
