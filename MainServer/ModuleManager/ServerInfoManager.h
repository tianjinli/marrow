...
// 数组定义
using CGameServerInfoArray = std::vector<tagGameServerInfo*>;
using CGameMatchOptionArray = std::vector<tagGameMatchOption*>;

// 索引定义
using CGameServerInfoMap = std::unordered_map<WORD, tagGameServerInfo*>;
using CGameMatchOptionMap = std::unordered_map<DWORD, tagGameMatchOption*>;
...
public:
  ...
  // 加载私人房间配置
  bool LoadPersonalRoomParameter(tagPersonalRoomOption& pesronalRoomOption, tagPersonalRoomOptionRightAndFee& personalRoomOptionRightAndFee,
                                 WORD wServerID);

  // 插入私人房间参数
  bool InsertPersonalRoomParameter(CDataBaseAide PlatformDBAide, tagPersonalRoomOption PersonalRoomOption,
                                   tagPersonalRoomOptionRightAndFee PersonalRoomOptionRightAndFee, WORD dwServerID, WORD dwKindID);

  // 修改私人房间参数
  bool ModifyPersonalRoomParameter(CDataBaseAide PlatformDBAide, tagPersonalRoomOption PersonalRoomOption,
                                   tagPersonalRoomOptionRightAndFee PersonalRoomOptionRightAndFee, WORD dwServerID, WORD dwKindID);

  // 写文件
  void WriteFileValue(LPCTSTR pszKeyName, LPCTSTR pszItemName, UINT nValue, CSimpleIni& ini_reader);
