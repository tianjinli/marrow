...
//////////////////////////////////////////////////////////////////////////////////
using CUserGameDataMap = std::unordered_map<int, tagGameDataItem*>;
...
private:
  ...
  // 是否为纯数字
  bool IsPureDigitString(const StringT& source);
  // 有效性判断
  bool IsValidGameData(const StringT& strSource, const StringT& strSpliter);
