...
// 数组数组
using CAndroidUserItemArray = std::vector<CAndroidUserItem*>;
using CAndroidParameterArray = std::vector<tagAndroidParameterEx*>;
using CAndroidUserItemMap = std::unordered_map<DWORD, CAndroidUserItem*>;
...
public:
  // 机器数目
  virtual WORD GetAndroidCount() { return (WORD) m_AndroidUserItemMap.size(); }
  // 库存数目
