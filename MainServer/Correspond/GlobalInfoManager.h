...
// 数组定义
using CGlobalUserItemArray = std::vector<CGlobalUserItem*>;
using CGlobalPlazaItemArray = std::vector<CGlobalPlazaItem*>;
using CGlobalServerItemArray = std::vector<CGlobalServerItem*>;
using CGlobalChatItemArray = std::vector<CGlobalChatItem*>;

// 索引定义
using CMapUserID = std::unordered_map<DWORD, CGlobalUserItem*>;
using CMapGameID = std::unordered_map<DWORD, CGlobalUserItem*>;
using CMapPlazaID = std::unordered_map<WORD, CGlobalPlazaItem*>;
using CMapServerID = std::unordered_map<WORD, CGlobalServerItem*>;
using CMapChatID = std::unordered_map<WORD, CGlobalChatItem*>;
using CMapNickName = std::unordered_map<StringT, CGlobalUserItem*>;
using CMapPersonalTableInfo = std::unordered_map<StringT, tagPersonalTableInfo*>;
...
using CServerTableCountArray = std::vector<tagServerTableCount*>;
...
protected:
  ...
  CMapNickName m_MapNickName; // 昵称索引
...
public:
  ...
  // 添加桌子
  bool AddServerTable(StringT strServerID, tagPersonalTableInfo PersonalTable);
  // 移除桌子
