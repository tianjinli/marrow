...
// 税收定义
#define REVENUE_BENCHMARK 0      // 税收起点
#define REVENUE_DENOMINATOR 1000 // 税收分母
...
// 列表质数
#define PRIME_TYPE 11     // 种类数目
#define PRIME_KIND 53     // 类型数目
#define PRIME_NODE 101    // 节点数目
#define PRIME_PAGE 53     // 自定数目
#define PRIME_SERVER 1009 // 房间数目

// 人数质数
#define PRIME_SERVER_USER 503      // 房间人数
#define PRIME_ANDROID_USER 503     // 机器人数
#define PRIME_PLATFORM_USER 100003 // 平台人数
...
#define LEN_DEVICE_TOKEN 65    // 设备标识长度
#define LEN_FACE_URL 500       // 头像URL
#define LEN_PLACE_NAME 33      // 地名长度
...
// 房间规则
#define SRL_ONLOOK 0x00000001  // 旁观标志
...
// 扩展属性
#define UD_BANKER 4     // 银行
#define UD_WIN_LOST 5   // 输赢情况
#define UD_IS_ANDROID 6 // 机器人？
#define UD_IS_CONTROL 7 // 是否控制
...
#define LEN_GAMEOVER_DATA 50 // 数据长度

#define MAX_PASSWORD_COUNT 10 // 密码个数
