...
public class ThirdDefine {
	...
	//appid
	public static String  WeixinAppID  = "wx2e643767738f0a82";
	//secret
	public static String WeixinAppSecret = "ab52d10bca37a3884cc0a822d5b59f28";	
	//商户id
	...
	//分享链接
	public static String  ShareURL = "http://www.bb762.com";
	//分享标题
	public static String   ShareTitle = "762游戏中心";
	//分享内容
	public static String   ShareContent = "762游戏中心目前有李逵劈鱼、飞禽走兽、奔驰宝马、连环夺宝、水浒传、三九连线、金鲨银鲨、森林舞会等电玩类游戏，更有拼三张赢话费比赛、竞技牛牛、21点等棋牌游戏。";
