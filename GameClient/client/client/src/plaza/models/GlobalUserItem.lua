...
function GlobalUserItem.onLoadData(pData)
    ...
    print("readstring wFaceID", GlobalUserItem.wFaceID);
	GlobalUserItem.cbGender = pData:readbyte()
    print("readstring cbGender", GlobalUserItem.cbGender);
	GlobalUserItem.dwCustomID = pData:readdword()
    print("readstring dwCustomID", GlobalUserItem.dwCustomID);
	GlobalUserItem.dwUserID = pData:readdword()
    print("readstring dwUserID", GlobalUserItem.dwUserID);
	GlobalUserItem.dwGameID = pData:readdword()
    print("readstring dwGameID", GlobalUserItem.dwGameID);
	GlobalUserItem.dwExperience = pData:readdword()
	GlobalUserItem.dwLoveLiness = GlobalUserItem:readScore(pData) --pData:readdword() --GlobalUserItem:readScore(pData)
    print("readstring szAccount");
	GlobalUserItem.szAccount = pData:readstring(32)
    print("readstring szNickName");
	GlobalUserItem.szNickName = pData:readstring(32)
    print("readstring szDynamicPass");
